...
global.ownername = process.env.Owner_Name || "KRISHANx";
global.ownernumber = process.env.Owner_Number || "94764224187";
global.adress = process.env.Continent || "Asia, India, Srilanka";
global.timezone = process.env.TimeZone || "Asia/colombo";
global.instagramId = process.env.Insta || "8.08_only_mine";
global.email = process.env.Email_Id || "krishanxsl@gmail.com";

global.mongoUrl = process.env.MongoDB |mongodb+srv://KRISHAN:KrishanDuminda@cluster0.5brepu4.mongodb.net/| "Enter"; 
...
global.sessionId = process.env.SESSION_ID || "Houn_AN_YA_dAn_AN_YA_tique";
